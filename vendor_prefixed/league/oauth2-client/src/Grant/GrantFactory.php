 ...
 */
namespace WPFormsTribe\Vendor\League\OAuth2\Client\Grant;

use WPFormsTribe\Vendor\League\OAuth2\Client\Grant\Exception\InvalidGrantException;
/**
...
class GrantFactory
{
    ...
    protected function registerDefaultGrant($name)
    {
        ...
        $class = 'WPFormsTribe\\Vendor\\League\\OAuth2\\Client\\Grant\\' . $class;
