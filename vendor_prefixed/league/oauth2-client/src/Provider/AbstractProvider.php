...
use WPFormsTribe\Vendor\GuzzleHttp\Client as HttpClient;
use WPFormsTribe\Vendor\GuzzleHttp\ClientInterface as HttpClientInterface;
use WPFormsTribe\Vendor\GuzzleHttp\Exception\BadResponseException;
use InvalidArgumentException;
use WPFormsTribe\Vendor\League\OAuth2\Client\Grant\AbstractGrant;
use WPFormsTribe\Vendor\League\OAuth2\Client\Grant\GrantFactory;
use WPFormsTribe\Vendor\League\OAuth2\Client\OptionProvider\OptionProviderInterface;
use WPFormsTribe\Vendor\League\OAuth2\Client\OptionProvider\PostAuthOptionProvider;
...
use WPFormsTribe\Vendor\League\OAuth2\Client\Token\AccessTokenInterface;
use WPFormsTribe\Vendor\League\OAuth2\Client\Tool\ArrayAccessorTrait;
use WPFormsTribe\Vendor\League\OAuth2\Client\Tool\GuardedPropertyTrait;
use WPFormsTribe\Vendor\League\OAuth2\Client\Tool\QueryBuilderTrait;
use WPFormsTribe\Vendor\League\OAuth2\Client\Tool\RequestFactory;
use WPFormsTribe\Vendor\Psr\Http\Message\RequestInterface;
use WPFormsTribe\Vendor\Psr\Http\Message\ResponseInterface;
