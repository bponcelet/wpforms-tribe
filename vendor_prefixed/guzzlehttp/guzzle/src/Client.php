...
use WPFormsTribe\Vendor\GuzzleHttp\Cookie\CookieJar;
use WPFormsTribe\Vendor\GuzzleHttp\Exception\GuzzleException;
use WPFormsTribe\Vendor\GuzzleHttp\Promise;
...
use WPFormsTribe\Vendor\Psr\Http\Message\UriInterface;
/**
...
class Client implements ClientInterface
{
    ...
    private function applyOptions(RequestInterface $request, array &$options)
    {
        ...
        if (isset($options['json'])) {
            $options['body'] = \WPFormsTribe\Vendor\GuzzleHttp\json_encode($options['json']);
            unset($options['json']);
            // Ensure that we don't have the header in different case and set the new value.
            $options['_conditional'] = Psr7\_caseless_remove(['Content-Type'], $options['_conditional']);
